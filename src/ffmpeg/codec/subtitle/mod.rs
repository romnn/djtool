...
impl From<AVSubtitleType> for Type {
    fn from(value: AVSubtitleType) -> Type {
        match value {
            AVSubtitleType::SUBTITLE_NONE => Type::None,
            AVSubtitleType::SUBTITLE_BITMAP => Type::Bitmap,
            AVSubtitleType::SUBTITLE_TEXT => Type::Text,
            AVSubtitleType::SUBTITLE_ASS => Type::Ass,
        }
    }
}
...
impl From<Type> for AVSubtitleType {
    fn from(value: Type) -> AVSubtitleType {
        match value {
            Type::None => AVSubtitleType::SUBTITLE_NONE,
            Type::Bitmap => AVSubtitleType::SUBTITLE_BITMAP,
            Type::Text => AVSubtitleType::SUBTITLE_TEXT,
            Type::Ass => AVSubtitleType::SUBTITLE_ASS,
        }
    }
}
